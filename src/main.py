...
async def main() -> None:
    ...
    parser.add_argument('-s', dest="only_series", action='store_const', const="Filters=IsFolder", default="")
    parser.add_argument('-e', dest="only_episode", action='store_const', const="Filters=IsNotFolder", default="")
    parser.add_argument('-m', dest="only_movies", action='store_const', const="IsMovie=True", default="")
    ...
    match choiced_media.type:
        ...
        case "Movie":
            ...
            await saveMedia(Path(choiced_media.name), Path(choiced_media.name), media_stream, media_size)   
